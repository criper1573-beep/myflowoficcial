...
- **Level 1 tasks:** предложи пользователю следующий шаг — запустить `/build` или написать **build** (реализацию не начинать без явного запроса).
- **Level 2-4 tasks:** предложи пользователю перейти к планированию — запустить `/plan` или написать **план**.
